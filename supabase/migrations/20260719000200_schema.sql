...
create index query_analytics_created_at_idx on public.query_analytics (created_at);
create index query_analytics_refused_idx on public.query_analytics (refused, created_at);
